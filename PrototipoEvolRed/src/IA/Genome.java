 ...
 *
 * @author Miguel Askar
 * Esta es la misma clase genoma del entrenamiento, utilizada para cargar el genoma desde el archivo plano a analizar.
 */
public class Genome 
{
    ...
    public double calculateFitness()
    {
        try
        {
            fitness= (double)correctDiagnosis/(double)possibleDiagnosis;
    ...
    {
        return String.valueOf(age[1] + "," + gender + "," + pressure[1] + "," + cholesterol[1] + "," +
                sugar + "," + electro + "," + hearRate[1] + "," +
                type);
    }
